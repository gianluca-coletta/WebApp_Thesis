...
CREATE TABLE `corsodilaurea` (
  `CodiceCL` varchar(25) NOT NULL,
  `Titolo` varchar(70) DEFAULT NULL,
  PRIMARY KEY (`CodiceCL`)
...
INSERT INTO `corsodilaurea` VALUES ('L021','Economia aziendale'),('L08A','Ingegneria informatica ed elettronica'),('LM01','Giurisprudenza');
...
-- Dump completed on 2020-12-19 21:36:01
